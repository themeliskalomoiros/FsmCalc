...
public class StateMachineShould
{
    ...
    [InlineData(State.Init, Alphabet.Decimal, State.FirstOperand)]
    ...
    [InlineData(State.FirstOperand, Alphabet.OneOfTerm, State.FirstOperand)]
    [InlineData(State.FirstOperand, Alphabet.SquareRoot, State.FirstOperand)]
    [InlineData(State.FirstOperand, Alphabet.PowerOfTwo, State.FirstOperand)]
    [InlineData(State.FirstOperand, Alphabet.Sign, State.FirstOperand)]
    [InlineData(State.FirstOperand, Alphabet.Decimal, State.FirstOperand)]
    ...
    [InlineData(State.SecondOperand, Alphabet.Percent, State.SecondOperand)]
    [InlineData(State.SecondOperand, Alphabet.OneOfTerm, State.SecondOperand)]
    [InlineData(State.SecondOperand, Alphabet.SquareRoot, State.SecondOperand)]
    [InlineData(State.SecondOperand, Alphabet.PowerOfTwo, State.SecondOperand)]
    [InlineData(State.SecondOperand, Alphabet.Sign, State.SecondOperand)]
    [InlineData(State.SecondOperand, Alphabet.Decimal, State.SecondOperand)]
    ...
    [InlineData(State.Result, Alphabet.Addition, State.SecondOperand)]
    [InlineData(State.Result, Alphabet.Subtraction, State.SecondOperand)]
    [InlineData(State.Result, Alphabet.Multiplication, State.SecondOperand)]
    [InlineData(State.Result, Alphabet.Division, State.SecondOperand)]
    ...
    [InlineData(State.Result, Alphabet.Decimal, State.Result)]
